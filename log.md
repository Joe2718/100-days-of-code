...
### Day 14: Dec 24th Done with the advanced algorithms, only had those two that had issues with recognition of correct answer.  Yes, i'm positive I have the correct answers since I even wrote a checking program where you can just copy and paste from left side of the screen to the code and have it check.  I made pictures and satisfied my paranoia but I just don't want to bother with the little things like that right now.  
Trying to decide 
